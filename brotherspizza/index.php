			...
			<div class="pizza-list-inner">
				...
				<div class="list-grid pizza-list-grid">
					<div class="grid-element">
						<a href="pizzaDetails.php?id=cp1">
					...
					<div class="grid-element">
						<a href="pizzaDetails.php?id=cp2">
							<div class="grid-image">
					...
					<div class="grid-element">
						<a href="pizzaDetails.php?id=cp3">
							<div class="grid-image">
					...
					<div class="grid-element">
						<a href="pizzaDetails.php?id=cp4">
							<div class="grid-image">
				...
				<div class="list-grid pizza-list-grid">
					<div class="grid-element">
						<a href="pizzaDetails.php?id=vp1">
							<div class="grid-image">
					...
					<div class="grid-element">
						<a href="pizzaDetails.php?id=vp2">
							<div class="grid-image">
					...
					<div class="grid-element">
						<a href="pizzaDetails.php?id=vp3">
							<div class="grid-image">
					...
					<div class="grid-element">
						<a href="pizzaDetails.php?id=vp4">
							<div class="grid-image">
