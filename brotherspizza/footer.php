    ...
    <div class="footer-inner">
        <div class="footer-top">
            <div class="brand-details">
                <h5>Brothers Pizza</h5>
                <p>Enjoy yummy pizzas from Brothers Pizza!<br> We make them with the best ingredients<br> and deliver them to your door<br> quickly for a tasty treat at home</p>
                <button class="order-button" style="margin: 30px 0;">Get In Touch</button> 
            </div>
            <div class="section-1">
                <h5>
                    Contact Us
            ...
            <div class="section-3">
                ...
                <ul>
                    ...
                    <li>Quality Ingredient</li>
                    <li>Express Delivery</li>
                    <li>Hygenic Practices</li>
                    <li>Customer Support</li>
                </ul>
            </div>
        </div>
        <div class="footer-bottom">
            <p style="margin: 0">&#169;Copyright <a href="index.php" style="color: white; text-decoration: none;">Brothers Pizza</a>. All Rights Reserved</p>
        </div>
    </div>
</div>